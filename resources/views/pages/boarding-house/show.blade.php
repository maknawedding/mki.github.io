...
<div id="Content-Container"
        ...
        <div id="TopNavAbsolute" class="absolute top-[60px] flex items-center justify-between w-full px-5 z-10">
            ...
            <button
                class="w-12 h-12 flex items-center justify-center shrink-0 rounded-full overflow-hidden bg-white/10 backdrop-blur-sm">
                <img src="{{asset('assets/images/icons/like.svg')}}"
                class="w-[26px] h-[26px]" alt="">
            </button>
        </div>
                        ...
                        @foreach ($boardingHouse->testimonials as $testimonial)
                            <div class="testi-card flex flex-col rounded-[22px] border border-[#F1F2F6] p-4 gap-3 bg-white hover:border-[#91BF77] transition-all duration-300">
                                ...
                                <div class="flex">
                                    ...
                                    @for ($rating = 0; $rating < $testimonial->rating; $rating++)
                                    <img src="{{asset('assets/images/icons/star.svg')}}" class="w-[22px] h-[22px] flex shrink-0"
                                    alt="">
                                    @endfor
